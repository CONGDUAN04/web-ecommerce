...
CREATE TABLE `Order` (
    ...
    `status` ENUM('PENDING', 'CONFIRMED', 'SHIPPING', 'COMPLETED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURN_APPROVED', 'RETURNED') NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE `ReturnEvidence` (
    ...
    INDEX `ReturnEvidence_returnRequestId_idx`(`returnRequestId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
